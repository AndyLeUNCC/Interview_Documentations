...
public class SCircle extends SShape 
{
    ...
    /**
     * Constructor for circle, initializes state
     * from a string representation. Does
     * the work by calling the inherited constructor
     * that in turn calls fromString()
     * @param str string representation of a circle
     */
    public SCircle(String str)
    {
        super(str);
    }
     ...
     * from a string representation of a circle.
     * @param str string representation of a circle
     */
    @Override
     ...
     * showing the center of the circle and the radius.
     * @return string representation of the shape
     */
    @Override
    public String toString()
    {
        Point p = getControl(0);
        String s = super.toString() + 
            "circle "+p.x+" "+p.y+" "+getRadius()+"\n";
        return s;
    }
}
