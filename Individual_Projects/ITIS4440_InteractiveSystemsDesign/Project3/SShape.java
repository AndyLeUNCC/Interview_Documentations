...
public abstract class SShape
{
    ...
    /**
     * Constructor for a shape, initializes state
     * from a string representation. The parsing is
     * delegated to the method toString(). This
     * initializes the instance variables.
     * @param str string representation of a shape
     */
    ...
    /**
     * Supports parsing a string representation
     * of an object.
    ...
    /**
     * Returns the number of handles in this shape.
    ...
    /**
     * Returns the number of control points in this shape.
    ...
    /**
     * Private convert Color to string by returning a string
     * representaiton with three integers, red, green, and blue.
     ...
     * showing the border color and the fill color (if the
     * object was set to be filled).
    ...
    public String toString()
    {
        if (getFillColor() != null) {
            String s = 
                "border "+toString(getBorderColor())+"\n"+
                "fill "+toString(getFillColor())+"\n";
            return s;
        }
        else {
            String s = 
